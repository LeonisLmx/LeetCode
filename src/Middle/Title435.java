...
public class Title435 {
    ...
    public int eraseOverlapIntervals(int[][] intervals) {
        ...
        int length = intervals.length,result = 1,end = intervals[0][1];
